...
``soda-data`` documentation uses Sphinx_ as its main documentation compiler.
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/soda-data.git
    cd soda-data
...
#. Install |pre-commit|_::
   ...
   ``soda-data`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/soda-data
.. _issue tracker: https://github.com/<USERNAME>/soda-data/issues
.. <-- end -->
